...
export const RegistrationPanel: React.FC = () => {
  ...
  const checkoutPage = usePathname();
  ...
  return (
    <DirectionWrapper direction="row">
      <DropdownMenu>
        <DropdownMenuTrigger
          className={`  
            text-[16px] justify-center font-[900]
            text-[rgba(254,95,0,1)] py-[13px] px-4 max-w-[110px] w-full border-1 
            border-[rgba(254,95,0,1)] rounded-[5px] flex items-center gap-[10px]
            ${nunito600.className}`}
        >
